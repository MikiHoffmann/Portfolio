let images = ['blazerInProgress.png','orangeBlazer.jpg','insidePocket.png','newyearseveDress.png','orangeSleeve.jpg','cancanTorso.png','sinterklazenMontmartre.png'];
...
for(let i = 0; i < images.length; i++) {
    ...
    galleryItem.src = 'mIMG/101projects/gallery/' +  images[i];
